...
// Vendored from `htm` package, with some modifications.
...
type Hype<HResult> = (type: any, props: Record<string, any>, ...children: any[]) => HResult;
type HTMEvaluator<HResult> = (strings: TemplateStringsArray, ...values: any[]) => HResult | HResult[];

export function bind<HResult>(h: Hype<HResult>): HTMEvaluator<HResult> {
  return regular.bind(h);
}
